...
namespace SabberStoneCoreAi
{
    internal class Program
    {
		...
		private static string player_weights_file;
		private static string opponent_weights_file;
		private static int numLoops;

		//20200305 Connor - NeuralNetWeights list of weights
		public static List<double[]> PlayerWeightsList = new List<double[]>();
		public static List<double[]> OpponentWeightsList = new List<double[]>();
		...
		public static void parseArgs(string[] args)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
				...
				else if (argument.Contains("playerweights="))
				{
					//20200326 - This is the fittest_log.csv file to load ANN weights for the NN score
					player_weights_file = argument.Substring(14);
				}
				else if (argument.Contains("opponentweights="))
				{
					//20200326 - This is the fittest_log.csv file to load ANN weights for the NN score
					opponent_weights_file = argument.Substring(16);
				}
			}
		...
		public static List<double[]> weightsfromfile(string weights_file)
		{
		...
		private static void Main(string[] args)
        {
			...
			PlayerWeightsList = weightsfromfile(player_weights_file);
			OpponentWeightsList = weightsfromfile(opponent_weights_file);
		...
		public static object GetNNPlayerScore(List<double[]> WeightsList)
		{
		...
		public static Tuple<object, object> GetAIPlayerFromScore(string P1Scoring, string P2Scoring)
		{
			...
			switch (P1Scoring.ToLower())
			{
				...
				case "ramp":
					...
					break;
				case "network":
					aiP1 = GetNNPlayerScore(PlayerWeightsList);
					break;
			}
			switch (P2Scoring.ToLower())
			{
				...
				case "ramp":
					...
					break;
				case "network":
					aiP2 = GetNNPlayerScore(OpponentWeightsList);
					break;
			}
